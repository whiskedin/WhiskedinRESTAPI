...
class WhiskyTests(WhiskedTest):
    ...
    def test_update_whisky(self):
        ...
        updated_whisk = Whisky.update_whisky(self.whisky_dict)
    ...
    def test_post_whisky_endpoint(self):
        ...
        added_whisky_response = self.app.post('/whiskies', data=self.whisky_dict, headers={'Authorization': 'Bearer %s'
                                                                                                            % token})
    ...
    def test_put_whisky_endpoint(self):
        ...
        updated_whisky = self.app.put('/whiskies', data=updated_whisky_dict,
                                      headers={'Authorization': 'Bearer %s' % token}).json['whisky']
    ...
    def create_test_whisky(self, uid=1):
        whisky_to_create = self.whisky_dict.copy()
        if uid != 1:
